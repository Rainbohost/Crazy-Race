...
public class RCC_Editor : Editor {
	...
	[MenuItem("Tools/X-Zone Games/Car Controller/Add Main Controller To Vehicle", false, -85)]
	...
	[MenuItem("Tools/X-Zone Games/Car Controller/Add Main Controller To Vehicle", true)]
